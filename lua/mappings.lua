...
keyset('n', '<leader>d', ':Gitsigns diffthis<CR>', { noremap = true, unique = true, silent = false })
...
-- Source file
keyset("n", "<leader>s", ":source<CR>", { noremap = true, unique = true, silent = false })
...
-- Packer
keyset("n", "<leader>py", ":PackerSync<CR>", { noremap = true, unique = true, silent = false })
keyset("n", "<leader>ps", ":PackerStatus<CR>", { noremap = true, unique = true, silent = false })
keyset("n", "<leader>pl", ":PackerClean<CR>", { noremap = true, unique = true, silent = false })
keyset("n", "<leader>po", ":PackerCompile<CR>", { noremap = true, unique = true, silent = false })
keyset("n", "<leader>pu", ":PackerUpdate<CR>", { noremap = true, unique = true, silent = false })
keyset("n", "<leader>pi", ":PackerInstall<UpdateCR>", { noremap = true, unique = true, silent = false })
